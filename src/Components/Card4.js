...
export default function Card4(){
    return(
        <div className="card custom-card-body shadow-sm">
            ...
            <div className="card-body p-4 custom-card-content-light text-dark">
                <h1 className="custom-h1 text-center">Laura Smith</h1>
                <h5 className="custom-h5-light text-center">Frontend Developer</h5>
                <h6 className="custom-h6 text-center">laurasmith.website</h6>

                <div className="d-flex justify-content-around pt-3 pb-3">
                    <a href="" className="btn btn-light btn-sm btn-outline-dark links-btn2"><i className="bi bi-envelope"/> Email</a>
                </div>
            ...
            <div className="card-footer custom-card-footer-light p-3">
